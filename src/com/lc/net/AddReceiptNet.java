	                ...
	                while (isRunning) {
					  try {
						//Thread.currentThread().sleep(10);
	         		    String strurl =ConnectUrl.addReceipt;
	                	URL url = null;
	                	try{
	                		url = new URL(strurl);
	                		...
	                		String content = "authn=" + URLEncoder.encode(authn, "UTF-8")
	                				...
	                				+"&billHead=" + URLEncoder.encode(billHead, "UTF-8")
	                				+"&acceptName=" + URLEncoder.encode(acceptName, "UTF-8")
