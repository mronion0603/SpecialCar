...
public class DelAddressNet {
	private Handler handler;
	private boolean isRunning = false;
	String result = "网络连接错误！";
	String authn = "";
	String device= "";
	String commAddressId= "";
	public DelAddressNet(){
	                ...
	                while (isRunning) {
					  try {
						//Thread.currentThread().sleep(10);
	         		    String strurl =ConnectUrl.delAddress;
	                	URL url = null;
	                	try{
	                		url = new URL(strurl);
	                		...
	                		String content ="authn=" + URLEncoder.encode(authn, "UTF-8")
	                				...
	                				+"&commAddressId=" + URLEncoder.encode(commAddressId, "UTF-8")
	                				;
