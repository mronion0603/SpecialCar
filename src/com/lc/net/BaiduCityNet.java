	              ...
	              public void run() {       
	                while (isRunning) {
					  try {
	                	...
	                	//URL url = null;
	                	try{
	                		String spec = "http://api.map.baidu.com/geocoder/v2/?ak="  
	                                + URLEncoder.encode(ak, "UTF-8")
	                                +"&callback=" + URLEncoder.encode("renderReverse", "UTF-8")
	                                +"&location=" + location
	                                +"&output=" + URLEncoder.encode(output, "UTF-8")
	                                +"&pois=" + URLEncoder.encode("1", "UTF-8")
