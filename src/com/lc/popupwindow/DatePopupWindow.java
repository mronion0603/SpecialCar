...
public class DatePopupWindow extends PopupWindow {
	...
	public DatePopupWindow(Activity context,OnClickListener itemsOnClick) {
		super(context);	
		init(context);
	...
	public DatePopupWindow(Activity context) {
		super(context);
		init(context);
		Button confirm  = (Button) mMenuView.findViewById(R.id.comfirm);
	...
	void init(Activity context){
		...
		mMenuView = inflater.inflate(R.layout.date_layout, null);
