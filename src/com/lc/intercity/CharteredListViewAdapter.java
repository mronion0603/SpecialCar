...
public class CharteredListViewAdapter extends BaseAdapter {
    ...
    public CharteredListViewAdapter(Context context, List<HashMap<String,Object>> listItems) {   
    ...
    public View getView(int position, View convertView, ViewGroup parent) {   
       ...
       // final int selectID = position;   
        ...
        if (convertView == null) {   
            ...
            //获取list_item布局文件的视图   
            convertView = listContainer.inflate(R.layout.activity_intercity_searcharcar_listitem, null);   
            //获取控件对象   
